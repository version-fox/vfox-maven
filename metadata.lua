...
--- Plugin homepage
PLUGIN.homepage = "https://github.com/version-fox/vfox-maven"
--- Plugin license, please choose a correct license according to your needs.
PLUGIN.license = "Apache 2.0"
--- Plugin description
PLUGIN.description = "Maven runtime environment."
...
NOTE:
 ...
 --]]
PLUGIN.manifestUrl = "https://github.com/version-fox/vfox-maven/releases/download/manifest/manifest.json"
